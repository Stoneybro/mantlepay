...
interface BatchPyusdTransferToolProps extends BaseToolProps {
    mutation: any;
}

export function BatchPyusdTransferTool({
    part,
    callId,
    addToolResult,
    isTransactionPending,
    mutation
}: BatchPyusdTransferToolProps) {
        ...
        case 'output-available':
            return (
                <div key={callId} className="my-2 text-sm flex flex-col">
                    <div className="flex items-center gap-1"><Check className="h-4 w-4" /> Batch PYUSD transfer confirmed</div>
