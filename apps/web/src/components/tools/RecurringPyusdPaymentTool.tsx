...
interface RecurringPyusdPaymentToolProps extends BaseToolProps {
    mutation: any;
}

export function RecurringPyusdPaymentTool({
    part,
    callId,
    addToolResult,
    isTransactionPending,
    mutation
}: RecurringPyusdPaymentToolProps) {
        ...
        case 'output-available':
            return (
                <div key={callId} className="my-2 text-sm flex flex-col">
                    <div className="flex items-center gap-1"><Check className="h-4 w-4" /> Recurring PYUSD payment created</div>
